...
set_input_delay  0.1 -clock rclk [remove_from_collection [all_inputs] rclk]
set_input_delay  0.1 -clock wclk [remove_from_collection [all_inputs] wclk]
set_output_delay 0.1 -clock rclk [all_outputs]
set_output_delay 0.1 -clock wclk [all_outputs]
